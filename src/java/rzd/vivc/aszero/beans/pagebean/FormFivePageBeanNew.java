...
@ManagedBean
@ViewScoped
public class FormFivePageBeanNew extends BasePage implements Serializable {

    public FormFivePageBeanNew() {
        super();
    }
 ...
 if(session != null && session.getUser() != null){
     ...
     System.out.println(dayBeginD.getMonth());
      ...
      //  if(dayBeginD.getMonth()!=dayEndD.getMonth()){};
        ...
        if(t_mes1){
        detailsForm5ListSQL=(new ReportRepository()).getListWithDetailsForm5((int) session.getUser().getDepartmentPower(), dayBeginD, dayEndD);
        }
         if(!t_mes1){
        detailsForm5ListSQL=(new ReportRepository()).getListWithDetailsForm5Per((int) session.getUser().getDepartmentPower(), dayBeginD, dayEndD);
        }
         int k=-1;
  ...
  reportDetailsForm5List.add(sumDor);    
    ...
    public void Print(Object document) {
        ...
        for (int i = 0; i < reportDetailsForm5List.size(); i++) {
            ...
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 1, 1, 1, f.formatForEXCEL(reportDetailsForm3.getPlanE().floatValue()));


            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 2, 2, 2, f.formatForEXCEL(reportDetailsForm3.getFactE().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 3, 3, 3, f.formatMoneyForEXCEL(reportDetailsForm3.getFactEM().floatValue()));

            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 8, 8, 8, f.formatForEXCEL(reportDetailsForm3.getFactS().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 9, 9, 9, f.formatMoneyForEXCEL(reportDetailsForm3.getFactSM().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 10, 10, 10, f.formatForEXCEL(reportDetailsForm3.getFactO().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 11, 11, 11, f.formatForEXCEL(reportDetailsForm3.getFactO2().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 12, 12, 12, f.formatForEXCEL(reportDetailsForm3.getFactY0().floatValue()));
            new createCell().createCell(wb, sheet, cellStyle1, header8, jk, jk + reportDetailsForm3.getCell4().size() - 1, 13, 13, 13, f.formatForEXCEL(reportDetailsForm3.getFactY2().floatValue()));
