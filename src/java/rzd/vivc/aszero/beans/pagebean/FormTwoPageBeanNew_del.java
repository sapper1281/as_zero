...
@ManagedBean
@ViewScoped
public class FormTwoPageBeanNew_del extends BasePage implements Serializable {

    public FormTwoPageBeanNew_del() {
        super();
    }
 ...
 /*по дороге + определение цвета*/
            for (DetailsForm2 detailsForm2 : listf2dop) {
                ...
                if (detailsForm2.getIdRep() != null) {
                    ...
                    dt_b_m1.setTime(dt_b.getTime() - 86400 * 1000 + 10800000 - num * 60 * 1000);


                    Date dt_f_p1 = new Date();
                    //дата окончания проведения акции +3 дня 12 часов
                    dt_f_p1.setTime(dt_f.getTime()/* + 86400 * 1000 */ + 10800000 - num * 60 * 1000);
