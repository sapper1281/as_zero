 ...
 * @author apopovkin
 */
public class createCellNull {
    public static void createCellNull(HSSFSheet sheet,CellStyle cellStyle, Row row,
            int rowfirst,int rowlast, int column,int columnfirst,int columnlast
            ) {
