 ...
 * @author apopovkin
 */
public class InputASKYERepository  extends BaseRepository{
    ...
    public <T > void save(T elem){
        ...
        try {
            ...
            Logger.getLogger(InputASKYERepository.class.getName()).log(Level.ERROR, null, e);
            if (t != null) {
                try {
                    t.rollback();
                } catch (HibernateException he) {
                    Logger.getLogger(InputASKYERepository.class.getName()).log(Level.ERROR, null, he);
                }
            }
        } finally {
            try {
